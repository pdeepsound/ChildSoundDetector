...
Для использования систем распознавания звуков необходимо загрузить предобученные модели. Предобученные модели могут быть загружены по [ссылке](https://drive.google.com/file/d/146KR9GxppqiCRfJFBp83EiuV68UIbkwy/view?usp=sharing).
...
1) Точность детектирования голоса няни
...
2) Точность детектирования звуков ребенка
| Класс   | mAP          | Количество примеров |
| ------------- | :---: | :---: | 
...
3) Точность классификации детских звуков
| Класс   | mAP          | Количество примеров |
| ------------- | :---: | :---: | 
...
4) Точность детектирования плача ребенка
| Класс   | mAP          | Количество примеров |
| ------------- | :---: | :---: | 
...
5) Точность классификации плача ребенка
| Класс   | mAP          | Количество примеров |
| ------------- | :---: | :---: | 
